...
namespace Plugin.Screenshot
{
    ...
    public class CrossScreenshot
    {
        ...
        private static Lazy<IScreenshot> Implementation = new Lazy<IScreenshot>(() => CreateScreenshot(), System.Threading.LazyThreadSafetyMode.PublicationOnly);
        ...
        private static IScreenshot CreateScreenshot()
        {
#if PORTABLE
            return null;
#else
